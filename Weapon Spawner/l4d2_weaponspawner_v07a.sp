 ...
 */
 ...
 /*
		TODO
		zrobic usuwanie tylko miniguna i osobno usuwanie innych propow
		zrobic generowanie menu z cfg broni (dodac l4d1)
		porownania srringow z tablic
		naprawic jedno tlumaczenie
		napawic brak dodawania ammo do awp
		dodac zeby nie mozna bylo usunac miniguna jak go ktos uzywa (chyba sprawdzajac m_hOwner)
		zrobic zeby spawnowane karnistry mogly wybuchac od razu (chyba m_hasBeenUsed)
		
		dodac nieskonczone ammo z pily
		dodac nieskonczone ammo podpalajace i wybuchowe
		dodac nieskonczone ammo z kazdej broni
		sprawdzic czy da sie ustawic wiecej specjalnego ammo
		
		!trudne!
		spawnowaæ bronie melee (chyba m_iViewModelIndex i m_iWorldModelIndex) w tym bronie normalnie niedostepne
		zrobic zeby bronie z cs mialy damage
 */
