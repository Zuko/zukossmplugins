...
public OnPluginStart_VoteSound()
{
	...
	g_Cvar_Sound[Sound_VoteStart] = CreateConVar("sm_mapvote_sound_votestart", "sourcemod/mapchooser/startyourvoting1.mp3", "Sound that is being played when a vote starts. (relative to $basedir/sound/)");
	g_Cvar_Sound[Sound_VoteEnd] = CreateConVar("sm_mapvote_sound_voteend", "sourcemod/mapchooser/endofvote1.mp3", "Sound that is being played when a vote ends. (relative to $basedir/sound/)");
}
